    ...
    <section className='row'>
      <div id="contact" className="contact-main">
        ...
        <div className="contact-flex">
          ...
          <div className="contact-links">
            <a href="https://www.canva.com/design/DADnjqFen2U/view" target="_blank" rel="noopener noreferrer"><i class="far fa-file-alt"><span className='icon-names'>Resume</span></i></a>
          </div>
          <div className="contact-links">
